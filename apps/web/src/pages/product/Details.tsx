        ...
        <div className="grid items-start grid-cols-1 gap-8 lg:grid-cols-2 max-lg:gap-16">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                type="button"
                className="w-full lg:w-auto min-w-[200px] px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded-md"
              >
                Add to cart
              </button>
            </div>
